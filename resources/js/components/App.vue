    ...
    <div>
        <div class="layout">
            <div class="layout-topbar clearfix">
                <div class="layout-name" :class="{'sider-mini': isCollapse}">
                    <router-link class="full" to="/" v-if="!isCollapse">Agencies and Lead</router-link>
        ...
        <div v-loading="$root.store.state.loading" class="layout-body"
            ...
            <aside class="layout-sider">
                ...
                <el-scrollbar style="height: calc(100% - 126px);">
                    <el-menu :unique-opened="true"
                             background-color="#2a323c"
                             text-color="#fff"
                             :default-active="$root.currentRoute"
                             :router="true">
                ...
                nav: [
                    {
                        ...
                        type: 'menu-item',
                        data: {
                            route: 'view-business_entity',
                            text: 'Business Entities'
                        }
                    }, {
                        type: 'menu-item',
                        data: {
                            route: 'view-employee_category',
                        ...
                        type: 'menu-item',
                        data: {
                            route: 'view-salutation_code',
                            text: 'Salutation Codes'
                        }
                    },{
                        type: 'menu-item',
                        data: {
                            route: 'view-lead_status_code',
                            text: 'Lead Status Codes'
                        }
                    },{
                        type: 'menu-item',
                        data: {
                            route: 'view-lead_outcome_code',
                            text: 'Lead Outcome Codes'
                        }
                    },{
                        type: 'menu-item',
                        data: {
                            route: 'view-workflow_action',
                            text: 'Workflow Actions'
                        }
                    },{
                        type: 'menu-item',
                        data: {
                            route: 'view-customers_lead',
